...
\begin{document}
    ...
    Die Intensität der inneren Kräfte wird in einem materiellen Körper durch die Spannungen charakterisiert.
    ...
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[|<->|] (0,-1) -- (1.5,-1) node[midway,fill=white] {\(\frac{\d y}{2}\)};
            \draw[<->|] (1.5,-1) -- (3,-1) node[midway,fill=white] {\(\frac{\d y}{2}\)};
            \draw[|<->|] (4.5,0) -- (4.5,1) node[midway,fill=white] {\(\frac{\d z}{2}\)};
            \draw[<->|] (4.5,1) -- (4.5,2) node[midway,fill=white] {\(\frac{\d z}{2}\)};
            \draw (0,0) rectangle (3,2);
            \draw (1.5,1) circle (.5mm) node[right] {\(M\)};
            \draw[->] (1.25,2.1) -- (1.75,2.1) node[above right] {\(\tau_{yz}\)};
            \draw[->] (1.5,2.2) -- (1.5,2.7) node[right] {\(\sigma_z\)};
            \draw[->] (3.1,.75) -- (3.1,1.25) node[above right] {\(\tau_{zy}\)};
            \draw[->] (3.2,1) -- (3.7,1) node[below] {\(\sigma_y\)};
            \draw[->] (1.75,-.1) -- (1.25,-.1) node[below left] {\(\tau_{yz}\)};
            \draw[->] (1.5,-.2) -- (1.5,-.7) node[right] {\(\sigma_z\)};
            \draw[->] (-.1,1.25) -- (-.1,.75) node[below left] {\(\tau_{zy}\)};
            \draw[->] (-.2,1) -- (-.7,1) node[above] {\(\sigma_y\)};
        \end{tikzpicture}
    \end{center}
    ...
    \begin{center}
        ...
        \begin{tikzpicture}
            \begin{scope}[rotate=20]
                \draw[->] (0,0) -- (3,0) coordinate (B) node[right] {\(\xi\)};
                \draw[->] (0,0) -- (0,3) node[right] {\(\eta\)};
                \draw (0,0) rectangle (2,2);
                \draw[->] (-.1,1.25) -- (-.1,.75);
                \draw[->] (-.2,1) -- (-.7,1);
                \draw[->] (1.25,-.1) -- (.75,-.1);
                \draw[->] (1,-.2) -- (1,-.7);
                \draw[->] (2.1,.75) -- (2.1,1.25) node[above right] {\(\tau_{\eta\xi}\)};
                \draw[->] (2.2,1) -- (2.7,1) node[right] {\(\sigma_\xi\)};
                \draw[->] (.75,2.1) -- (1.25,2.1) node[above] {\(\tau_{\xi\eta}\)};
                \draw[->] (1,2.2) -- (1,2.7) node[above] {\(\sigma_\eta\)};
            \end{scope}
